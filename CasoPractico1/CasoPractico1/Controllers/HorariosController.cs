...
namespace CasoPractico1.Controllers
{
    public class HorariosController : Controller
    {
        ...
        public HorariosController(TransporteDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("HorarioId,RutaId,VehiculoId,Hora")] Horario horario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HorarioId,RutaId,VehiculoId,Hora")] Horario horario)
        {
